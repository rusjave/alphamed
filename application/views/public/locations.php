...
<div class="services-content">
    ...
    <div class="container-fluid">
        <div class="row">
			...
			<div class="col-md-2">
				<img alt="140x140" data-src="holder.js/140x140" class="img-rounded pull-right" style="width: 140px; height: 140px;" src="<?php echo base_url('assets/images/alphamed-slider7.jpg'); ?>" data-holder-rendered="true">
			...
			<div class="col-md-2">
				<img alt="140x140" data-src="holder.js/140x140" class="img-rounded pull-right" style="width: 140px; height: 140px;" src="<?php echo base_url('assets/images/alphamed-slider6.jpg'); ?>" data-holder-rendered="true">
